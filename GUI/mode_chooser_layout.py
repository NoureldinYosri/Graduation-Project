...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.general_img_btn.setStyleSheet(_fromUtf8(""))
        ...
        self.separate_video_btn.setStyleSheet(_fromUtf8(""))
        ...
        self.separate_img_btn.setStyleSheet(_fromUtf8(""))
        ...
        self.label.setStyleSheet(_fromUtf8("color: rgb(255, 121, 32);"))
        ...
        self.general_video_btn.setStyleSheet(_fromUtf8(""))
        ...
        self.track_players_btn.setStyleSheet(_fromUtf8(""))
        ...
        self.track_ball_btn.setStyleSheet(_fromUtf8(""))
