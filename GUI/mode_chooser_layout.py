...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.general_video_btn.setStyleSheet(_fromUtf8("background-image: url(button_bg.png)"))
        ...
        self.track_ball_btn.setStyleSheet(_fromUtf8("background: url(:/button_bg.png)"))
